  ...
  <div>
    ...
    <div class="container mc flex">
      ...
      <nav class="category mc">
        ...
        <router-link class="category-item" to="/materials/input-group">
          <el-icon>
            <EditPen />
          </el-icon>
          <div>文本输入</div>
        </router-link>
        <router-link class="category-item" to="/materials/advanced-group">
          <el-icon>
            <Files />
          </el-icon>
          <div>高级题型</div></router-link
        >
        <router-link class="category-item" to="/materials/note-group">
          <el-icon>
            <ChatLineSquare />
          </el-icon>
          <div>备注说明</div></router-link
        >
        <router-link class="category-item" to="/materials/personal-info-group">
          <el-icon>
            <User />
          </el-icon>
          <div>个人信息</div>
        </router-link>
        <router-link class="category-item" to="/materials/contact-group">
          <el-icon>
            <Message />
          </el-icon>
